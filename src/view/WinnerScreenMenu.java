...
public class WinnerScreenMenu extends Menu {
    
    private int round;
    private Player cp;
    private Player np;
    
    public WinnerScreenMenu(Scanner in, int round, Player current_player, Player next_player) {
        Menu.in = in;
        this.round = round;
    ...
    protected void displayMenu() {
        System.out.println();
        System.out.println("*** " + cp.getName() + " is Victorious!" + " ***");
        System.out.println(cp.getName() + " won in " + round + " rounds.");
    }
